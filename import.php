...
<?php /*<table id="tbl" cellpadding=4 cellspacing=0 style="position:relative;width:70%;z-index:1;left:350;text-align:left;font-size:10pt;">
...
<?
    ...
    ob_start();
    ShowFileSelect('cat_file','Файл каталога в '.$UPLOAD_DIR.'/1c_catalog/:',$UPLOAD_DIR.'/1c_catalog/','xml',10,'ConfirmImport(\'catalog\')');
