...
<?/*					<a href="javascript:void(0)" class="bx_bt_button bx_medium" onclick="catalogSetPopupObj.Add2Basket();"><span class="bx_icon_cart"></span><span><?=$arMessage["CATALOG_SET_BUY"]?></span></a>*/?>
					<a href="javascript:void(0)" class="button2" onclick="catalogSetPopupObj.Add2Basket();"><span class="bx_icon_cart"></span><?=$arMessage["CATALOG_SET_ADD2BASKET"]?></a>
				</div>
			</div>
