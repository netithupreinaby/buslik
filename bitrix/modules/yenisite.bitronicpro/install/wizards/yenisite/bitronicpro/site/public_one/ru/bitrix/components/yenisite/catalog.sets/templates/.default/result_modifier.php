			...
			if ('SB' == $arParams['PRODUCT_DISPLAY_MODE'])
			{
				...
				foreach ($item['OFFERS'] as $keyOffer => $arOffer)
				{
					...
					if (!$arOffer['OWNER_PICT'])
					{
						...
						$arOffer['PREVIEW_PICTURE'] = CResizer2Resize::ResizeGD2($offerPictures['PICT']['SRC'],$arParams['RESIZER2_SET_BIG']);
						$arOffer['PREVIEW_PICTURE_SMALL'] = CResizer2Resize::ResizeGD2($offerPictures['PICT']['SRC'],$arParams['RESIZER2_SET_SMALL']);
					}
