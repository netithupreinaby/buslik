<?    
    ...
    $MESS ['SET_COMMON'] = "Параметры";
	
	$MESS ['ID'] = "ID";
	$MESS ['STATUS_DRAFT'] = "STATUS_DRAFT";
	$MESS ['STATUS_PUBLISHED'] = "STATUS_PUBLISHED";
	
	
	$MESS ['SET_IBLOCK'] = "Настройки разделов";
    $MESS ['DELETE'] = "Удалить";
    $MESS ['REGION'] = "ID региона c Яндекса";
    $MESS ['EDIT'] = "Изменить";
    $MESS ['NAME'] = "Название <span style='color: red'>*</span>";
    $MESS ['ADD'] = "Создать набор";
	$MESS ['ADD_IBLOCK'] = "Добавить инфоблок";
	$MESS ['INCLUDE_SUBSECTIONS'] = "Обрабатывать элементы в подразделах выбранных разделов";
	$MESS ['TURBO_PROP_FOR_SELECT'] = "Свойство-чекбокс для обработки модулем";
	$MESS ['TURBO_PROP_FOR_SELECT_TOOLTIP'] = "Модулем будут обрабатываться только те товары, у которых установлено выбранное свойство";
	
	$MESS ['TURBO_ELEM_STATUS'] = "Статус товара";
	$MESS ['TURBO_ELEM_ALL'] = "Обрабатывать все товары";
	$MESS ['TURBO_ELEM_ACTIVE'] = "Обрабатывать активные товары";
	$MESS ['TURBO_ELEM_AVAILABLE'] = "Обрабатывать товары в наличии";
	$MESS ['TURBO_ELEM_ACTIVE_AVAILABLE'] = "Обрабатывать активные товары в наличии";
	
    $MESS ['YES'] = "Да";
    $MESS ['NO'] = "Нет";
    $MESS ['IBLOCK_ID'] = "Инфоблок <span style='color: red'>*</span>";
    $MESS ['SECTION_ID'] = "Раздел инфоблока";
    $MESS ['DISCOUNT'] = "Скидка от минимальной цены(%) <br/>(позволяет повысить рентабельность в случае<br/>если минимальная цена больше вашей) <span style='color: red'>*</span>";
    $MESS ['RENT'] = "Рентабельность(%) <span style='color: red'>*</span>";
    $MESS ['PRICE_ID'] = "Цена закупочная <span style='color: red'>*</span>";
    $MESS ['ERROR'] = "Ошибка: не заполнены обязательные поля";    
	$MESS ['PLACE'] = "Какое место хотите занимать?";
	$MESS ['DELIVERY'] = "Прибавить к цене стоимость доставки в заданный регион";
