...
<h1>Инструкция по работе с модулем Ресайзер 2.0</h1>
<br/>
...
<br/>Генерация фотографии в Ресайзере 2.0 происходит на лету, после чего сохраняется на диске у вас на сервере. В данном разделе можно сбросить кеш всех фотографий, сгенерированных Ресайзером 2.0. Например если вы поменяли водяной знак. В Ресайзере 2.0 есть так же функционал автоматического сброса кэша при изменении набора, причем кэш будет сброшен только для измененного набора.

<br/><br/>В комплекте с Ресайзером 2.0 идет компонент resizer2.box (+ шаблоны), который позволяет выводить фотографии элемента используя созданные наборы. В настройках компонента необходимо указать ID элемента. Такой компонент можно вставлять в стандартные шаблоны компонентов news.list, news.detail, catalog.element, catalog.section, catalog.top вместо выводя фотографий анонса и детальной.

<br/><br/>
<div style="clear: right; float: left; width: 90%; border: 1px solid #000000; padding: 10px; margin-bottom: 0px;">Смотрите <a href="http://dev.1c-bitrix.ru/community/webdev/user/51651/blog/resizer2-setup/">инструкцию</a> по установке и настройке модуля</a>.</div>
<br style="clear:both"/>
<br/>
<br/>
<table width="100%">
...
<td><b>Код для вставки resizer2.box на страницу списка элементов</b></td>
</tr>
...
<b>Внимание!!!</b> для того чтобы работали jquery библиотеки их необходимо подключить самостоятельно, либо выделить галочками в <a href="/bitrix/admin/yci_resizer2_wm.php?lang=ru">настройках</a> модуля "Ресайзер 2.0". Учтите, если у вас уже подключены одноименные библиотеки и вы подключите их повторно в настройках модуля - может возникнуть конфликт.<br/><br/>

<br/><br/>Если будут вопросы, пожалуйста, пишите в нашу <a href="http://www.yenisite.ru/support/">техническую поддержку</a> (предварительно необходимо будет зарегистрироваться).
