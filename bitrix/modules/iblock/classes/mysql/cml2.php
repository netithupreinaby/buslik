...
class CIBlockXMLFile
{
	...
	*/
    ...
    /*-----------------Кастомная функция добавления записи для буслик--------*/
    
    
    
    function AddBuslik($arFields)
    {
        global $DB;
        static $arFieldHolder;
        
        
        if(count($arFieldHolder)<=250)
        {        
            $arFieldHolder[]=$arFields;
        ...
        $strSql1 = "PARENT_ID, LEFT_MARGIN, RIGHT_MARGIN, DEPTH_LEVEL, NAME, ATTRIBUTES, VALUE";
        $strSql2='';
        
        foreach($arFieldHolder as $arFields)
        {
