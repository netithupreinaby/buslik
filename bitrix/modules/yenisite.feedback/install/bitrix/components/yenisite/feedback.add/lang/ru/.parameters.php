...
$MESS ['NAME_FIELD'] = "Сделать именем элемента";
$MESS ['TITLE'] = "Заголовок формы";
$MESS ['SUCCESS_TEXT'] = "Текст, выводимый при успешном добавлении сообщения";
$MESS ['USE_CAPTCHA'] = "Использовать CAPTCHA";
$MESS ['PRINT_FIELDS'] = "Выводимые поля";
$MESS ['TEXT_REQUIRED'] = "Поле 'Сообщение' - обязательное";
$MESS ['TEXT_SHOW'] = "Показывать поле 'Сообщение'";
$MESS ['SECTION_CODE'] = "Код раздела (оставьте пустым чтобы появился выпадающий список разделов)";
$MESS ['SHOW_SECTIONS'] = "Показывать разделы в выпадающем списке";
$MESS ['ELEMENT_ID'] = "ID элемента";
$MESS ['COLOR_SCHEME'] = "Цветовая схема";

$MESS ['NAME'] = "Ф.И.О.";
$MESS ['EMAIL'] = "E-mail";
$MESS ['PHONE'] = "Телефонный номер";
$MESS ['MESSAGE'] = "Сообщение";
$MESS ['ACTIVE'] = "Активировать элемент после добавления";
$MESS ['EVENT_NAME'] = "Название почтового события";

$MESS ['CS_GREEN'] = "Зеленая";
$MESS ['CS_ICE'] = "Голубая";
$MESS ['CS_METAL'] = "Серая";
$MESS ['CS_PINK'] = "Розовая";
$MESS ['CS_RED'] = "Красная";
$MESS ['CS_YELLOW'] = "Желтая";

$MESS ['AJAX_REDIRECT'] = "Включить редирект после добавления (для разрабочиков)";
?>