...
/*	"CAPTION_EVAL" => Array(
			"PARENT" => "YENISITE_RESIZER2_PARAMETERS",
			"NAME" => GetMessage("CAPTION_EVAL"),
			"TYPE" => "LIST",
			"VALUES" => array(	'this.a.title'=>"Да",
								''=>"Нет",),	
			"DEFAULT" => '',
		),	*/
	...
	"SLIDE_REPEAT" => Array(
			"PARENT" => "YENISITE_RESIZER2_PARAMETERS",
			"NAME" => GetMessage("SLIDE_REPEAT"),
			"TYPE" => "LIST",
			"VALUES" => array(	'true'=>"Да",
								'false'=>"Нет"),	
			"DEFAULT" => 'false',
		),
		
	"CONTROL_OPACITY" => Array(
			"PARENT" => "YENISITE_RESIZER2_PARAMETERS",
			"NAME" => GetMessage("CONTROL_OPACITY"),
			"TYPE" => "LIST",
			"VALUES" => array('0'=>"100%",'0.1'=>"90%",'0.2'=>"80%",'0.3'=>"70%",'0.4'=>"60%",'0.5'=>"50%",'0.6'=>"40%",'0.7'=>"30%",'0.8'=>"20%",'0.9'=>"10%",'1'=>"0%"),
			"DEFAULT" => '1',		
		),
	"CONTROL_POSITION" => Array(
			...
			"TYPE" => "LIST",
			"VALUES" => array(	'top left'=>"Сверху/слева",
