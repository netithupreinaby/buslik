...
<?
if(!$arParams['SET_DETAIL']) $arParams['SET_DETAIL'] = 0;
if(!$arParams['SET_BIG_DETAIL']) $arParams['SET_BIG_DETAIL'] = 0;
if(!$arParams['SET_SMALL_DETAIL']) $arParams['SET_SMALL_DETAIL'] = 0;
