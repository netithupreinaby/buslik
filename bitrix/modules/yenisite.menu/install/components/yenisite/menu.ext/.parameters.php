...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		/*
		"SECTION_ELEMENT_CNT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("SECTION_ELEMENT_CNT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		
		"IBLOCK_ELEMENT_CNT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("IBLOCK_ELEMENT_CNT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		*/
		...
		/* "SECTION_SORT_FIELD" => array(
			...
			"VALUES" => array(
				"id" => GetMessage("IBLOCK_SORT_ID"),
				"section" => GetMessage("SECTION_SORT_SECTION"),
				"name" => GetMessage("IBLOCK_SORT_NAME"),
				"code" => GetMessage("IBLOCK_SORT_CODE"),
				"active" => GetMessage("IBLOCK_SORT_ACTIVE"), 
				"left_margin" => GetMessage("SECTION_SORT_LEFT_MARGIN"),
				"depth_level" => GetMessage("SECTION_SORT_DEPTH_LEVEL"),
				"sort" => GetMessage("IBLOCK_SORT_SORT"),
				"created" => GetMessage("SECTION_SORT_CREATED"),
				"created_by" => GetMessage("SECTION_SORT_CREATED_BY"),
				"element_cnt" => GetMessage("IBLOCK_SORT_ELEMENT_CNT"),
				"timestamp_x" => GetMessage("IBLOCK_SORT_DATE"),
			),
			"DEFAULT" => "left_margin",
...
*/
		...
		"GET_SECTION_UF" => array (
			"PARENT" => "BASE",
			"NAME" => GetMessage("GET_SECTION_UF"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N"
		),
		"ELEMENT_CNT" => array(
