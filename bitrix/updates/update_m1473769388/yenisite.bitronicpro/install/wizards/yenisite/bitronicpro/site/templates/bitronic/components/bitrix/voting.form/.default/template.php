...
<div class="voting-form-box poll">
...
?>
<?/*?>
	<div class="vote-item-title vote-item-question"><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></div>
...
<div class="vote-form-box-buttons vote-vote-footer">
	<span class="vote-form-box-button vote-form-box-button-first">
		<input type="submit" class="button" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>"/>
	</span>
