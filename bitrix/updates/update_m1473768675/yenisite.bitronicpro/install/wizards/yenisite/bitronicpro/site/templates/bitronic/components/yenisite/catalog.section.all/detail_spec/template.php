...
<div id="slider" class="detail_slider_2">
	...
	<div class="slider"><?if(count($arResilt['ITEMS']) > 4):?><button id="button7" onClick="javascript:void(0);" class="button7 sym">&#212;</button> <button id="button8" onClick="javascript:void(0);" class="button8 sym">&#215;</button><?endif;?>
