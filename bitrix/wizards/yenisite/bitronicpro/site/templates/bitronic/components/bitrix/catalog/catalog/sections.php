...
$by = strtolower($by);
if (!in_array($order, array(strtolower($arParams['LIST_PRICE_SORT']), 'name', 'property_sale_ext', 'property_sale_int', 'property_rating', 'sort', 'property_week_counter', 'show_counter')) ||
...
<?if ($sef == "Y"):?>
	...
	<input type="hidden" name="ys-iblock-url" value="<?=$arResult["IBLOCK_URL"]?>" />
<?endif;?>
...
<form name="sort_form">
	...
	<?if($arParams["SET_STATUS_ABCD"] == "Y"):?>
		<input id='abcd' type='hidden' value='<?=$letter?>' name='letter' />
	<?endif;?>
	...
	<div class="filter">
		...
		<div class="inler">
			...
			<div class="f_pop">
				...
				<button title="<?=GetMEssage("DESCENDING"); ?>" class="button11 sym <?=($order=="property_week_counter" && ($by=='DESC' || $by=='desc'))?"active":"";?>" onclick="setSortFields('property_week_counter', 'DESC', event); return false;">&#123;</button>
				<?if($sef == "Y"):?>
				...
				<?endif;?>
				<button title="<?=GetMEssage("ASCENDING"); ?>" class="button11 sym <?=($order=="property_week_counter" && ($by=='ASC' || $by=='asc'))?"active":"";?>" onclick="setSortFields('property_week_counter', 'ASC', event); return false;">&#125;</button>
				<?if($sef == "Y"):?>
			...
			<div class="f_sales">
				...
				<button title="<?=GetMEssage("DESCENDING"); ?>" class="button11 sym <?=($order=="property_sale_int" && ($by=='DESC' || $by=='desc'))?"active":"";?>" onclick="setSortFields('property_sale_int', 'DESC', event); return false;">&#123;</button>
				<?if($sef == "Y"):?>
				...
				<?endif;?>
				<button title="<?=GetMEssage("ASCENDING"); ?>" class="button11 sym <?=($order=="property_sale_int" && ($by=='ASC' || $by=='asc'))?"active":"";?>" onclick="setSortFields('property_sale_int', 'ASC', event);">&#125;</button>
				<?if($sef == "Y"):?>
			...
			<div class="f_sales">
				...
				<button title="<?=GetMEssage("DESCENDING"); ?>" class="button11 sym <?=($order=="property_rating" && ($by=='DESC' || $by=='desc'))?"active":"";?>" onclick="setSortFields('property_rating', 'DESC', event); return false;">&#123;</button>
				<?if($sef == "Y"):?>
				...
				<?endif;?>
				<button title="<?=GetMEssage("ASCENDING"); ?>" class="button11 sym <?=($order=="property_rating" && ($by=='ASC' || $by=='asc'))?"active":"";?>" onclick="setSortFields('property_rating', 'ASC', event); return false;">&#125;</button>
				<?if($sef == "Y"):?>
