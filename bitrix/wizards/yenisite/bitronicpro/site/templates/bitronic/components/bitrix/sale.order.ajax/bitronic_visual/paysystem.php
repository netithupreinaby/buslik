		...
		<tr>
			<td colspan="2" class="account">
				...
				<label for="PAY_CURRENT_ACCOUNT">
					<input type="checkbox" class="" name="PAY_CURRENT_ACCOUNT" id="PAY_CURRENT_ACCOUNT" value="Y"<?if($arResult["USER_VALS"]["PAY_CURRENT_ACCOUNT"]=="Y") echo " checked=\"checked\"";?> onChange="submitForm()">
...
*/
		?>
					...
					<tr>
						<td class="prop">
							<input type="radio" id="ID_PAY_SYSTEM_ID_<?=$arPaySystem["ID"]?>" name="PAY_SYSTEM_ID" value="<?=$arPaySystem["ID"]?>"<?=($arPaySystem["CHECKED"] == "Y" ? ' checked="checked"' : '')?> onclick="submitForm();" />
...
<? /*							<div class="paysystem_name">  */ ?>
								<div class="name" style="width: 600px; vertical-align: middle;  padding-top: 4px;">
