...
<tr valign="top">
	<td width="40%">
		<p>e-mail<br /><input class="txt" type="text" name="sf_EMAIL" size="20" value="<?echo $arResult["REQUEST"]["EMAIL"];?>" title="<?echo GetMessage("subscr_auth_email")?>" /></p>
...
<tfoot><tr><td colspan="2"><input class="button" type="submit" name="autorize" value="<?echo GetMessage("adm_auth_butt")?>" /></td></tr></tfoot>
</table>
