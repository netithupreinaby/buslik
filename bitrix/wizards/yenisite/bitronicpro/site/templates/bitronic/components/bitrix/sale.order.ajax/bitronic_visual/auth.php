                        ...
                        <form method="post" action="<?= $arParams["PATH_TO_ORDER"]?>" name="order_reg_form">
							...
							<div id="sof_choose_login">
								<div class="form-item">
									...
									<input  class="txt w240" type="text" name="NEW_LOGIN" maxlength="30" size="30" value="<?=$arResult["AUTH"]["NEW_LOGIN"]?>">
								</div><!--.form-item-->
								<div class="form-item">
                            ...
                            <div class="form-item">
								...
								<input class="txt w240" type="text" name="NEW_EMAIL" size="40" value="<?=$arResult["AUTH"]["NEW_EMAIL"]?>"/>                                
                            </div><!--.form-item-->
                            <div class="form-item">
                                <label><?echo GetMessage("STOF_NAME")?>:</label>
								<input class="txt w240" type="text" name="NEW_NAME" size="40" value="<?=$arResult["AUTH"]["NEW_NAME"]?>" />                                
                            </div><!--.form-item-->
                            <div class="form-item">
                                <label><?echo GetMessage("STOF_LASTNAME")?>:</label>
								<input class="txt w240" type="text" name="NEW_LAST_NAME" size="40" value="<?=$arResult["AUTH"]["NEW_LAST_NAME"]?>" />
                            </div><!--.form-item-->       
							<div class="form-item">
								<div>
