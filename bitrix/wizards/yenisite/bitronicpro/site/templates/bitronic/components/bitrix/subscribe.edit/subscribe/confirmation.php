...
<tr valign="top">
	<td width="40%">
		...
		<input class="txt" type="text" name="CONFIRM_CODE" value="<?echo $arResult["REQUEST"]["CONFIRM_CODE"];?>" size="20" /></p>
...
<tfoot><tr><td colspan="2"><input class="button" type="submit" name="confirm" value="<?echo GetMessage("subscr_conf_button")?>" /></td></tr></tfoot>
</table>
