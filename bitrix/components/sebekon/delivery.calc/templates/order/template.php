...
<script type="text/javascript">
	...
	<?if($_SESSION['sebekon_yaroute_name']!=''):?>
		sebDelivery<?=$arResult['ID']?>.coordsName = '<?=addslashes($_SESSION['sebekon_yaroute_name'])?>';
	<?endif;?>
	...
	ymaps.ready(function (){
		...
		<?if(isset($_SESSION['sebekon_yaroute_point']['x']) && isset($_SESSION['sebekon_yaroute_point']['y'])):?>
			deliveryObj.setDestination(false,['<?=$_SESSION['sebekon_yaroute_point']['x']?>','<?=$_SESSION['sebekon_yaroute_point']['y']?>']);
		<?else:?>
