...
$(function() {
	...
	$('.price_slider').each(function() {
		if ( $(this).find('.min-price').val() !== '' || $(this).find('.max-price').val() !== '' ) {
			$(this).show();
		}
	});

	$('.ys-opt').off('click').on('click', function() {
	...
	if ( window[bitronicAjaxFunctionName] && getType.toString.call(window[bitronicAjaxFunctionName]) === '[object Function]')
	{
		$(".showchild, #set_filter").click(function(e) {
			e.preventDefault();
...
$(function() {
	$('.hide_filtr').on('click', function() {
		//$(this).addClass("ys-hide_filtr");
		$(this).addClass("ys-hide_filtr");
		$(".rectangl-bottom").addClass("ys-hide_filtr");
		//$("#smartfilter").find(".ys-expand_table").addClass("toggleContent1").slideUp(400);
		$("#ys_filter_bitronic").find(".ys-expand_opt").slideUp();
		$('.show_filtr, .rectangl-top').removeClass("ys-hide_filtr");
		$('html, body').animate({
	...
	$('.show_filtr').on('click', function() {
		//$(this).hide();
		$(this).addClass("ys-hide_filtr");
		$(".rectangl-top").addClass("ys-hide_filtr");
		//$("#smartfilter").find(".ys-expand_table").slideDown(400);
		$("#ys_filter_bitronic").find(".ys-expand_opt").slideDown();
		$(".hide_filtr, .rectangl-bottom").removeClass("ys-hide_filtr");
		return false;
	});
