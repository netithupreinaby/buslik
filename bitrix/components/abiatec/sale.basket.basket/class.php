...
class CBitrixBasketAbiatecComponent extends CBitrixComponent
{
	...
	public function getBasketItems()
	{
		...
		foreach ($arOrder["BASKET_ITEMS"] as &$arOneItem)
		{
			...
			$arOneItem['DISCOUNT_PRICE_DIFF'] = $arOneItem['DISCOUNT_PRICE'];
			$arOneItem['DISCOUNT_PRICE_DIFF_FORMATED'] = CCurrencyLang::CurrencyFormat($arOneItem['DISCOUNT_PRICE_DIFF'], $arOneItem['CURRENCY'], true);
			$arOneItem['DISCOUNT_PRICE_DIFF_ALL'] = $arOneItem['DISCOUNT_PRICE'] * $arOneItem['QUANTITY'];
			$arOneItem['DISCOUNT_PRICE_DIFF_ALL_FORMATED'] = CCurrencyLang::CurrencyFormat($arOneItem['DISCOUNT_PRICE_DIFF'], $arOneItem['CURRENCY'], true);
		}
		unset($arOneItem);
