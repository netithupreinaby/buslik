...
<?
//$APPLICATION->AddHeadScript($templateFolder."/script_ajax.js");
			...
			<section class="cart-header">
						<div class="row">
                            <div class="col-lg-12 col-sm-12">
                                <div class="heading">
                                    <p class="page-title hidden-xs hidden-sm"><?php echo $APPLICATION->ShowTitle(); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alrt-wrapper">
							...
							<div class="bkng">
								<div class="booking clearfix">
									...
									<p>Резерв активен:</p>
									<p class="booking-time">1 ч 10 мин</p>
								</div>
							</div>
							<?php } ?>
							<? if(!empty($arResult['WARNING_MESSAGE'])){?>
							<div class="alert alrt alert-danger alert-dismissible" role="alert">
								<?
										foreach($arResult['ERROR'] as $key => $err) {
											if ($key !== 'BASKET') echo GetMessage("ERROR");
											echo '<p class="alert-text">'.$err, '</p><br/>';
										}?>
                            </div>
							<?}?>
                        </div>
