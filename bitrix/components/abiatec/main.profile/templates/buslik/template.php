...
<?include $_SERVER["DOCUMENT_ROOT"].SITE_TEMPLATE_PATH.'/include/cache_time_debug.php';?>
		...
		<?php include $_SERVER['DOCUMENT_ROOT'] . '/user/profile/' . $arResult['TEMPLATE_PAGE']; ?>
		...
		if ($arResult['DATA_SAVED'] == 'Y')
			print_r( "<script>jGrowl('".GetMessage('PROFILE_DATA_SAVED')."','ok');</script>");
			//echo ShowNote(GetMessage('PROFILE_DATA_SAVED'));	OLD ERROR MESSAGE (04.03.2013)
		?>
		...
		<?php /*<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
		...
		<table class="profile-table data-table">
			...
			<tr>
				...
				<td><input type="text" class="txt" name="NAME"  value="<?=$arResult["arUser"]["NAME"]?>" /></td>
			</tr>
			<tr>
				<td><?=GetMessage('LAST_NAME')?></td>
				<td><input type="text" class="txt" name="LAST_NAME"  value="<?=$arResult["arUser"]["LAST_NAME"]?>" /></td>
			</tr>
			<tr>
				<td><?=GetMessage('SECOND_NAME')?></font></td>
				<td><input type="text" class="txt" name="SECOND_NAME"  value="<?=$arResult["arUser"]["SECOND_NAME"]?>" /></td>
			</tr>
			<tr>
				<td><?=GetMessage('EMAIL')?><span class="starrequired">*</span></td>
				<td><input type="text" class="txt" name="EMAIL"  value="<? echo $arResult["arUser"]["EMAIL"]?>" /></td>
			</tr>
			<tr>
				<td><?=GetMessage('LOGIN')?><span class="starrequired">*</span></td>
				<td><input type="text" class="txt" name="LOGIN"  value="<? echo $arResult["arUser"]["LOGIN"]?>" /></td>
			</tr>
			<tr>
				<td><?=GetMessage('NEW_PASSWORD_REQ')?></td>
				<td><input type="password" class="txt" class="txt" name="NEW_PASSWORD"  value="" autocomplete="off" class="txt" />
		...
		<?endif?>
			...
			<tr>
				...
				<td><input type="password" class="txt" class="txt" name="NEW_PASSWORD_CONFIRM"  value="" autocomplete="off" /></td>
			</tr>
		<?if($arResult["TIME_ZONE_ENABLED"] == true):?>
			...
			<tr>
				...
				<td class="form-item">
					<select class="select" name="AUTO_TIME_ZONE" onchange="this.form.TIME_ZONE.disabled=(this.value != 'N')">
			...
			<tr>
				...
				<td class="form-item">
					<select class="select" name="TIME_ZONE"<?if($arResult["arUser"]["AUTO_TIME_ZONE"] <> "N") echo ' disabled="disabled"'?>>
		...
		<table class="data-table profile-table">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="txt" name="PERSONAL_PROFESSION" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PROFESSION"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_WWW')?></td>
					<td><input type="text" class="txt" name="PERSONAL_WWW" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_WWW"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_ICQ')?></td>
					<td><input type="text" class="txt" name="PERSONAL_ICQ" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_ICQ"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_GENDER')?></td>
					<td class="form-item">
					<select class="select" name="PERSONAL_GENDER">
				...
				<tr>
					...
					<td><input type="text" class="txt" name="PERSONAL_PHONE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_FAX')?></td>
					<td><input type="text" class="txt" name="PERSONAL_FAX" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_FAX"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_MOBILE')?></td>
					<td><input type="text" class="txt" name="PERSONAL_MOBILE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_MOBILE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_PAGER')?></td>
					<td><input type="text" class="txt" name="PERSONAL_PAGER" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PAGER"]?>" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" class="txt" name="PERSONAL_STATE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_STATE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_CITY')?></td>
					<td><input type="text" class="txt" name="PERSONAL_CITY" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_CITY"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_ZIP')?></td>
					<td><input type="text" class="txt" name="PERSONAL_ZIP" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_ZIP"]?>" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" class="txt" name="PERSONAL_MAILBOX" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_MAILBOX"]?>" /></td>
				</tr>
				<tr>
		...
		<table class="data-table profile-table">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="txt" name="WORK_COMPANY" maxlength="255" value="<?=$arResult["arUser"]["WORK_COMPANY"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_WWW')?></td>
					<td><input type="text" class="txt" name="WORK_WWW" maxlength="255" value="<?=$arResult["arUser"]["WORK_WWW"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_DEPARTMENT')?></td>
					<td><input type="text" class="txt" name="WORK_DEPARTMENT" maxlength="255" value="<?=$arResult["arUser"]["WORK_DEPARTMENT"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_POSITION')?></td>
					<td><input type="text" class="txt" name="WORK_POSITION" maxlength="255" value="<?=$arResult["arUser"]["WORK_POSITION"]?>" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><?=GetMessage('USER_PHONE')?></td>
					<td><input type="text" class="txt" name="WORK_PHONE" maxlength="255" value="<?=$arResult["arUser"]["WORK_PHONE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_FAX')?></font></td>
					<td><input type="text" class="txt" name="WORK_FAX" maxlength="255" value="<?=$arResult["arUser"]["WORK_FAX"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_PAGER')?></font></td>
					<td><input type="text" class="txt" name="WORK_PAGER" maxlength="255" value="<?=$arResult["arUser"]["WORK_PAGER"]?>" /></td>
				</tr>
				<tr>
					<td colspan="2" class="profile-header"><?=GetMessage("USER_POST_ADDRESS")?></td>
				</tr>
				...
				<tr>
					<td><?=GetMessage('USER_STATE')?></td>
					<td><input type="text" class="txt" name="WORK_STATE" maxlength="255" value="<?=$arResult["arUser"]["WORK_STATE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_CITY')?></td>
					<td><input type="text" class="txt" name="WORK_CITY" maxlength="255" value="<?=$arResult["arUser"]["WORK_CITY"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_ZIP')?></td>
					<td><input type="text" class="txt" name="WORK_ZIP" maxlength="255" value="<?=$arResult["arUser"]["WORK_ZIP"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage("USER_STREET")?></td>
				...
				<tr>
					<td><?=GetMessage('USER_MAILBOX')?></td>
					<td><input type="text" class="txt" name="WORK_MAILBOX" maxlength="255" value="<?=$arResult["arUser"]["WORK_MAILBOX"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage("USER_NOTES")?></td>
		...
		<table class="data-table profile-table">
			...
			<tbody>
				<tr>
					...
					<td><input type="checkbox" class="checkbox" name="forum_SHOW_NAME" value="Y" <?if ($arResult["arForumUser"]["SHOW_NAME"]=="Y") echo "checked=\"checked\"";?> /></td>
				</tr>
				<tr>
					<td><?=GetMessage('forum_DESCRIPTION')?></td>
					<td><input type="text" class="txt" name="forum_DESCRIPTION" maxlength="255" value="<?=$arResult["arForumUser"]["DESCRIPTION"]?>" /></td>
				</tr>
				<tr>
		...
		<table class="data-table profile-table">
			...
			<tbody>
				<tr>
					...
					<td><input class="typeinput txt" type="text" name="blog_ALIAS" maxlength="255" value="<?=$arResult["arBlogUser"]["ALIAS"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('blog_DESCRIPTION')?></td>
					<td><input class="typeinput txt" type="text" name="blog_DESCRIPTION" maxlength="255" value="<?=$arResult["arBlogUser"]["DESCRIPTION"]?>" /></td>
				</tr>
				<tr>
			...
			<table class="data-table profile-table">
				...
				<tbody>
					<tr>
						...
						<td><input type="checkbox" class="checkbox" name="student_PUBLIC_PROFILE" value="Y" <?if ($arResult["arStudent"]["PUBLIC_PROFILE"]=="Y") echo "checked=\"checked\"";?> /></td>
					</tr>
					<tr>
			...
			<p><input class='button' type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class='button' type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
		</form>*/?>
