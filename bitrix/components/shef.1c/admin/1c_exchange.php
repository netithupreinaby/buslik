...
CModule::IncludeModule("shef.bcs");
if($type=="sale")
{
	$APPLICATION->IncludeComponent("shef.1c:sale.export.1c", "", Array(
...
elseif($type=="catalog")
{
	$APPLICATION->IncludeComponent("shef.1c:catalog.import.1c", "", Array(
...
{
	$APPLICATION->IncludeComponent("shef.1c:catalog.import.hl", "", Array(
		"INTERVAL" => COption::GetOptionString("catalog", "1C_INTERVAL", "-"),
		"GROUP_PERMISSIONS" => explode(",", COption::GetOptionString("catalog", "1C_GROUP_PERMISSIONS", "1")),
		"FILE_SIZE_LIMIT" => COption::GetOptionString("catalog", "1C_FILE_SIZE_LIMIT", 200*1024),
		"USE_CRC" => COption::GetOptionString("catalog", "1C_USE_CRC", "Y"),
...
{
	$APPLICATION->IncludeComponent("shef.1c:catalog.export.1c", "", Array(
