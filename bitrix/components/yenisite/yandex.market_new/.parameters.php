...
{
	if ($bCatalog && $arCurrentValues['IBLOCK_CATALOG'] != 'N') {
...
if (!$bCatalog || $arCurrentValues['PRICE_FROM_IBLOCK'] == 'Y') {
...
if ($bCatalog && $arCurrentValues['IBLOCK_CATALOG'] == 'N')
{
	$arComponentParameters["PARAMETERS"]['PRICE_FROM_IBLOCK'] = array (
		"PARENT" => "PRICES",
...
if ( $bCatalog && $arCurrentValues['PRICE_FROM_IBLOCK'] != 'Y')
{
	...
	unset($arComponentParameters["PARAMETERS"]["OLD_PRICE_LIST"]["VALUES"]["TYPE_PRICE"]);
	unset($arComponentParameters["PARAMETERS"]["OLD_PRICE_LIST"]["VALUES"]["FROM_DISCOUNT"]);
}
if ( !$bCatalog ) {
...
} elseif ($arCurrentValues["OLD_PRICE_LIST"] == "PROP_PRICE" || !$bCatalog || $arCurrentValues['PRICE_FROM_IBLOCK'] == 'Y')
{
	$arComponentParameters["PARAMETERS"]["OLD_PRICE_CODE"] = array(
		"PARENT" => "OLD_PRICES",
		"NAME" => GetMessage("IBLOCK_OLD_PRICE_CODE"),
