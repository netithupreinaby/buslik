        ...
        function(){
            ...
            $(".yenisite-icons").click(
                function(){                    
                    ...
                    $("#yenisite-detail").attr("href", pathb);
					$("#yenisite-detail").attr("title", title);
            ...
            $.superbox.settings = {overlayOpacity: <?=$arParams['OVERLAY_OPACITY'];?>};
            $.superbox();
        }
    );
...
<div class="yenisite-bigphoto">
    <a class="yenisite-zoom" href="<?=$pathb?>" rel="superbox[image]" title="<?=$arResult["DESCRIPTION"][0]?>">
