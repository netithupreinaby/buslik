...
<?
$arParams["OVERLAY_OPACITY"] = (!isset($arParams["OVERLAY_OPACITY"]))? "0.8" : $arParams["OVERLAY_OPACITY"];
$arParams["SPEED"] = (!isset($arParams["SPEED"]))? "500" : $arParams["SPEED"];
...
<script type="text/javascript">
    ...
    $(document).ready(
        ...
        function(){
            var fancyZoomConf = {
                            overlay: <?=$arParams['OVERLAY_OPACITY'];?>,
            ...
            $(".yenisite-icons").click(
                function(){                    
                    ...
                    $('a.yenisite-zoom').unbind();
                    $('a.yenisite-zoom').fancyzoom(fancyZoomConf);
                }
            );
            $.fn.fancyzoom.defaultsOptions.imgDir='/yenisite.resizer2/js/fancyZoom/resources/';
            $('a.yenisite-zoom').fancyzoom(fancyZoomConf);
        }
    );
...
<div class="yenisite-bigphoto">
	...
	<img class="yenisite-detail" id='yenisite-detail' src="<?=$path?>" title="<?=$arResult["DESCRIPTION"][0]?>" alt="<?=$arResult["DESCRIPTION"][0]?>" />
    </a>
