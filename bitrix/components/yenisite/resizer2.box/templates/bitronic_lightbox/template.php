...
<div class="yenisite-bigphoto">
	<a class="yenisite-zoom" href="<?=$pathb?>" rel="lightbox" title="<?=$arResult["DESCRIPTION"][0]?>"><img class="yenisite-detail" src="<?=$path?>" title="<?=$arResult["DESCRIPTION"][0]?>" alt="<?=$arResult["DESCRIPTION"][0]?>" /></a>
