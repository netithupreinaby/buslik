<?
$MESS['CURRENCY_LIST'] = 'Валюта';
$MESS['DISCOUNT_CHECK'] = 'Учитывать скидку';
$MESS['EXISTENCE_CHECK'] = 'Выводить статус наличия';
$MESS["IBLOCK_PRICES"] = "Цены";
$MESS["FILE_NAME"] = "Путь до сохраняемого файла";
$MESS["FILE_TYPE"] = "Тип файла";
